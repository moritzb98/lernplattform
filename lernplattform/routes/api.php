...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('/room/get/{roomid}', [RoomController::class, 'getRoom']);
    ...
    Route::get('quiz/myquiz', [QuizController::class, 'getMyQuiz']);

    Route::get('quiz/getmyquizzes', [QuizController::class, 'getMyQuizzes']);
    ...
    Route::get('karteikarten/{setid}', [Karteikartencontroller::class, 'getKarten']);
});
